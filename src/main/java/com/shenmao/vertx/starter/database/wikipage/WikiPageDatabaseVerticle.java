...
import com.shenmao.vertx.starter.exceptions.ErrorCodes;
  ...
  public void start(Future<Void> startFuture) throws Exception {
    ...
    WikiPageDbService.create(dbClient, loadSqlQueries(), ready -> {
      ...
      if (ready.succeeded()) {
        ...
        (new ServiceBinder(vertx)).setAddress(CONFIG_WIKIDB_QUEUE).register(WikiPageDbService.class, ready.result());
