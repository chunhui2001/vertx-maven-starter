...
public class JsonToXMLConverter {
  ...
  public static JsonToXMLConverter create() {
    return new JsonToXMLConverter();
  }

  private static final String _ROOT_NAME = "response";
  ...
  public String convertJsonToXml(String json) throws IOException {
    return "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" + convertToXml(convertJson(json)).replaceAll("LinkedHashMap", _ROOT_NAME);
//    return null;
  }
