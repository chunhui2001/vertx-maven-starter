...
//        .setPath("ssh_keys/server-keystore.jks")
  ...
  public static synchronized AuthHandler create(Vertx vertx, String submount) {
    ...
    AuthHandler redirectAuthHandler = RedirectAuthHandler.create(shiroAuthProvider, submount + "/login");
