...
public class DemoVerticle extends AbstractVerticle {
  ...
  DemoHandlers demoHandlers = DemoHandlers.create(_MOUNT_DIR);
  DefaultHandlers defaultHandlers = DefaultHandlers.create(_MOUNT_DIR);
  ...
  public Router vertxDemoRouter() {
    ...
    vertxRouter.routeWithRegex(HttpMethod.GET, "/index" + DemoHandlers._SUPPORT_EXTS_PATTERN).handler(demoHandlers::indexHandler);
    ...
    routePingPost.handler(demoHandlers::indexHandler);
