...
public class MainVerticle extends AbstractVerticle {
  ...
  public void htmlRenderHandler(RoutingContext routingContext) {
    routingContext.request().headers().set("Accept", "text/html");
    routingContext.put("serializeOptions", new SerializeOptions(SerializeType.HTML));
    routingContext.next();
  }

  public void jsonSerializationHandler(RoutingContext routingContext) {
    routingContext.request().headers().set("Accept", "*/json");
    routingContext.put("serializeOptions", new SerializeOptions(SerializeType.JSON));
    routingContext.next();
  }

  public void xmlSerializationHandler(RoutingContext routingContext) {
    routingContext.request().headers().set("Accept", "*/xml");
    routingContext.put("serializeOptions", new SerializeOptions(SerializeType.XML));
    routingContext.next();
  }
  ...
  public void exceptionHandler(RoutingContext routingContext) {
    ...
    if (routingContext.failure() instanceof HbsTemplateNotFoundException) {
  ...
  public void start() {
    ...
    routeArticle.handler(routingContext -> {
      ...
      ChainSerialization.create(routingContext)
        .putViewName(routingContext,"/articles/article_detail.html")
        .putContextData(routingContext, contextData)
        .serialize();
    ...
    vertxRouter.route().handler(routingContext -> {
      ...
      routingContext.response().end("reponse serialization");
    });
